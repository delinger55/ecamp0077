...
var b;
const estudiantes = [
    {nombre: "Pablo", nota: 30},
    {nombre: "Raquel", nota: 55},
    {nombre: "Manuel", nota: 65},
    {nombre: "María", nota: 47},  
    {nombre: "Pedro", nota: 32}, 
    {nombre: "Víctor", nota: 56}, 
]

estudiantes.forEach((element) => console.log("Lista de estudiantes", element))
